...
module.exports = {
  ...
  handleReply: async function ({ api, event }) {
    try {
      ...
      const apiData = await axios.get('https://raw.githubusercontent.com/MOHAMMAD-NAYAN/Shourov/main/api.json');
      const apiUrl = apiData.data.sim;
      const kl = await axios.get(`https://raw.githubusercontent.com/MOHAMMAD-NAYAN/Shourov/main/api.json`);
