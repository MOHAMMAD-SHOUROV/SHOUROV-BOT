...
module.exports = {
  ...
  start: async function ({ nayan, events, args, lang }) {
    ...
    if (!args[0]) return shourov.reply(lang("missing"), events.threadID, events.messageID);
    ...
    try {
      ...
      console.error(err);
      return shourov.reply("Something went wrong. Please try again later.", events.threadID, events.messageID);
    }
  }
};
