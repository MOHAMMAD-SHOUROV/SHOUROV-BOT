...
module.exports = {
  ...
  start: async function ({ shourov, events, args, Threads }) {
    ...
    const threadInfo = await shourov.getThreadInfo(threadID);
    ...
    const initialThreadInfo = await shourov.getThreadInfo(threadID);
